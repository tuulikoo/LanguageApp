...
const MainPage = () => {
    return <>
                ...
                <div className={styles.nav_container} >
                    <ul className={styles.navbar_list}>
                        <Nav.Link className="nav-item">
                            <Link className={styles.nav_link} href={"/MainPage"}>🄷🄾🄼🄴</Link>
                        </Nav.Link>
        ...
        <div className={styles.hero_container}>
            <img src="https://wallpaperaccess.com/full/759396.jpg" className={styles.hero_img} />
            <h1 className={styles.hero_title}>🄻 🄴 🄰 🅁 🄽 🄸 🄽 🄶 <br/><span> 🄸🅂&ensp;🄿 🄾 🅆 🄴 🅁</span></h1>
            <a href="MainPage.js" className={styles.hero_button}>START</a>
        </div>
